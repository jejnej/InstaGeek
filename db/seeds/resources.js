  ...
  return knex('resources').del()
    .then(function () {
      return Promise.all([
        ...
        seedResourceFromUrl(knex, 'https://www.youtube.com/watch?v=ev9zrt__lec', 2, 2),
        ...
        seedResourceFromUrl(knex, 'https://www.youtube.com/watch?v=6E2UFAy_FxQ', 3, 2),
        seedResourceFromUrl(knex, 'https://www.britannica.com/science/polymerization', 3, 3),
        seedResourceFromUrl(knex, 'https://www.youtube.com/watch?v=bSlqA8nedGQ', 6, 3),
        ...
        seedResourceFromUrl(knex, 'https://www.sciencedaily.com/releases/2018/03/180327141726.htm', 8, 2),
        ...
        seedResourceFromUrl(knex, 'https://www.youtube.com/watch?v=URUJD5NEXC8', 5, 4),
        seedResourceFromUrl(knex, 'https://www.youtube.com/watch?v=qCLmR9-YY7o', 6, 4),
