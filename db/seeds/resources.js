  ...
  return knex('resources').del()
    .then(function () {
      return Promise.all([
        ...
        seedResourceFromUrl(knex, 'https://www.smithsonianmag.com/innovation/can-new-tech-help-planes-dodge-turbulence-180950369/', 2, 5),
        seedResourceFromUrl(knex, 'https://www.sciencedaily.com/releases/2017/10/171025141124.htm', 3, 5),
