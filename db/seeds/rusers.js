  ...
  return knex('rusers').del()
    .then(function () {
      return Promise.all([
        ...
        knex('rusers').insert({password: 'password', handle: 'BillyG', email: 'gates@mousemail.com', first_name: 'Bill', last_name: 'Gates', city: 'PaloAlto'}),
        knex('rusers').insert({password: 'password', handle: 'Emusk', email: 'elon@mousemail.com', first_name: 'Elon', last_name: 'Musk', city: 'Palo Alto'}),
        ...
        knex('rusers').insert({password: 'password', handle: 'Jbez', email: 'jeff@mousemail.com', first_name: 'Jeff', last_name: 'Bezos', city: 'Palo Alto'}),
